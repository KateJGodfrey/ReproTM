function [outname] = clean_dscalars_by_size_copy_jm_msi_update(dscalarwithassignments,manualset,groupnetworksfile,dostripes,mincol,minsize,orig_parcelsfile,make_consensus,assign_unassigned,remove46)
