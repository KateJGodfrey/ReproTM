...
# update log
# v2. (major update)
# i.  updated code to properly save the z-scored dconn (previously was writing old dconn)
...
# dconn_infile= dir_in + '/derivatives/dconn/sub-' + SUB + '/ses-' + SES + '/func/sub-' + SUB + '_ses-' + SES + '_task-' + TASK + 'MENORDICtrimmed_space-fsLR_den-91k_desc-denoised_bold_smoothed2mm_censoredFD2mm_noFisher.dconn.nii'
# dconn_outfile= dir_in + '/derivatives/dconn/sub-' + SUB + '/ses-' + SES + '/func/sub-' + SUB + '_ses-' + SES + '_task-' + TASK + 'MENORDICtrimmed_space-fsLR_den-91k_desc-denoised_bold_smoothed2mm_censoredFD2mm_noFisher_zscoreRH2.dconn.nii'
