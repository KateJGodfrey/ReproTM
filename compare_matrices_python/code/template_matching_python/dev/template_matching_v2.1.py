...
dconn_file='/sub-10227/ses-combined/func/sub-10227_ses-combined_task-crossMENORDICtrimmed_space-fsLR_den-91k_desc-denoised_bold_smoothed2mm_censoredFD2mm_zscoredRH.dconn.nii'
...
if refine_scan_network:
    ...
    # copy winner-take-all-results into an array 
    ...
    for i in range(sal_grays.shape[0]):
        ...
        if i % 5000 == 0:
            print('calculating sal greyordinate: ' + str(i))
...
if refine_scan_network:
    ...
    new_subject_labels = [x + 1 for x in new_subject_labels]
    new_subject_labels_scan = [x + 1 for x in new_subject_labels_scan]
    mat_dict={"eta_to_template_vox": eta_to_template_vox
            ,"eta_to_template_vox_scan":eta_to_template_vox_scan
            ,"r_to_template_vox":r_to_template_vox
            ,"r_to_template_vox_scan":r_to_template_vox_scan
