function twins_mapping_wrapper_washu_nordic(TR,FD_threshold,dt_or_ptseries_conc_file,motion_file,left_surface_file, right_surface_file, output_file_name, cifti_output_folder,template_path,surface_only,already_surface_only,output_directory, dtseries_conc,additional_mask, run_infomap_too)
...
%hardcodes:
memory_limit_value=4;
use_all_ABCD_tasks=0;
use_continous_minutes=1;
%run_infomap_too=0;
num_sub=length(dt_or_ptseries_conc_file);
%FD_threshold = 0.3;
smoothing_kernal = 2.25;
bit8 = 0;
%TR=1.761;
minutes_limit = 'none';
series = 'dtseries';
...
this_code = which('twins_mapping_wrapper_washu_nordic');
